...
这是一个解释型编程语言，基于 Golang 开发，目前仍在持续开发中。还没有<b>正式的名字</b>，暂且叫作 <b>Lit</b>。

最终我想把它实现为一个解释型的弱类型编程语言，希望它能用于日常的 Web 开发。

关于目前已实现的特性，请看如下文档示例，我将会定期更新：

当前文档更新日期是: 2022.11.10
...
##### 得益于 Golang 语言原生的一些高级特性，例如 管道、协程 这些可轻松实现异步操作的特性，Lit 会有更多扩展空间，它会比 php 更灵活、更小巧。
